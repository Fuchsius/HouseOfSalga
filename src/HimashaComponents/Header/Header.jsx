...
import dropdownIcon from '../../HimashaAssets/drop-down.png';
import searchIcon from '../../HimashaAssets/magnifyingglass.png';
import userIcon from '../../HimashaAssets/user.png';
import cartIcon from '../../HimashaAssets/Frame 2609102 (1).png';
import favIcon from '../../HimashaAssets/bag-04 (1).png';
    ...
    <header className="header" ref={wrapperRef}>
      <div className="header-container">
        ...
        <div className="left-section">
          ...
          <nav className="nav-links">
            <span
              ...
              onClick={() => navigate('/himasha-home')} // ✅ Navigate to Home.jsx
            >
              Home
            </span>
        ...
        <div className="right-section">
          ...
          <span
            className="nav-item hover-link"
            onClick={() => navigate('/signin')} // ✅ Navigate to SignIn.jsx
          >
            Login
          </span>
      ...
      {showMobileMenu && (
        <div className="mobile-menu">
          <div
            ...
            onClick={() => navigate('/himasha-home')} // ✅ Home
          >
            Home
          </div>
