...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className="bg-[#e0dcf0] rounded-lg shadow-sm overflow-hidden group hover:shadow-md transition-shadow max-w-[200px] max-h-[500px]  border-1 border-[#4D1727] auto-fit ">
