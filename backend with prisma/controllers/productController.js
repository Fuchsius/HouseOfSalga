...
const addProduct = async (req, res) => {
    ...
    try {
        ...
        console.error("Error creating product with variants/review:", error);
...
const deleteProduct = async (req, res) => {
    ...
    try {
        ...
        res.status(200).json({ message: "Product marked as inactive.", updatedProduct });
    } catch (error) {
