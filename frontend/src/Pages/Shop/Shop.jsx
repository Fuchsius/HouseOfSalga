...
const ShopPage = () => {
  ...
  useEffect(() => {
    fetch('http://localhost:5000/api/recentlyview')
      .then(res => res.json())
    ...
    <>
      ...
      <div className="shop-container">
        ...
        <div className="main-content">
          ...
          <div className="recently-viewed-section" style={{ marginBottom: '2rem', background: '#f9f9f9', padding: '1rem', borderRadius: '8px' }}>
              ...
              <ul>
                {recentlyViewed.map(item => (
                  <li key={item._id || item.id}>
                    {item.productName || item.name || JSON.stringify(item)}
                  </li>
                ))}
              </ul>
            )}
